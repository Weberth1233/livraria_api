...
public class DataBaseConfiguration {
    ...
    //Versão sem muito controle do banco de dados, apenas para exemplificar a criação do datasource
    //@Bean
    ...
    //Versão mais robusta com o hikari, permite mais controle de conexões e etc
    @Bean
    public DataSource hikariDataSource(){
        ...
        //Configurações adicionais para melhorar o controle de conexões do banco de dados
